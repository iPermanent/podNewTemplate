...
#        ["CPDAppDelegate.h", "CPDAppDelegate.m", "CPDViewController.h", "CPDViewController.m", "CPDAppEnvironment.h", "CPDAppEnvironment.m", "CPDHireachy.h", "CPDHireachy.m", "CPDAccountInstance.h","CPDAccountInstance.m", "CPDLoadMoreView.h", "CPDLoadMoreView.m"].each do |file|
